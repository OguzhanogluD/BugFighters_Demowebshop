...
public class TC_0101_Register_User extends BaseDriver {
    ...
    public void TC_0101 () {
        ...
        WebElement registertext = driver.findElement(By.xpath("(//div[@class='page-body'])[1]//div"));
        Assert.assertTrue("yanlis girdi girdiniz", registertext.getText().equals("Your registration completed"));
